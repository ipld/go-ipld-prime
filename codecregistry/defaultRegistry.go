...
// DefaultRegistry is a codecregistry.Registry instance which is global to the program,
...
// (for example, cidlink also has other LinkSystem constructor functions which accept an explicit codecregistry.Registry,
...
// If these are concerns for your program, you can create your own codecregistry.Registry values,
