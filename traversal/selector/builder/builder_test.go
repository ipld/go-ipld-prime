...
func TestBuildingSelectors(t *testing.T) {
	...
	t.Run("Matcher builds matcher nodes", func(t *testing.T) {
		sn := ssb.Matcher().Node()
		esn := fluent.MustBuildMap(ns, 1, func(na fluent.MapNodeAssembler) {
	...
	t.Run("ExploreAll builds ExploreAll nodes", func(t *testing.T) {
		...
		esn := fluent.MustBuildMap(ns, 1, func(na fluent.MapNodeAssembler) {
			na.AssembleDirectly(selector.SelectorKey_ExploreAll).CreateMap(1, func(na fluent.MapNodeAssembler) {
				na.AssembleDirectly(selector.SelectorKey_Next).CreateMap(1, func(na fluent.MapNodeAssembler) {
					na.AssembleDirectly(selector.SelectorKey_Matcher).CreateMap(0, func(na fluent.MapNodeAssembler) {})
				})
			})
		})
	...
	t.Run("ExploreRecursive builds ExploreRecursive nodes", func(t *testing.T) {
		...
		esn := fluent.MustBuildMap(ns, 1, func(na fluent.MapNodeAssembler) {
			na.AssembleDirectly(selector.SelectorKey_ExploreRecursive).CreateMap(2, func(na fluent.MapNodeAssembler) {
				...
				na.AssembleDirectly(selector.SelectorKey_Sequence).CreateMap(1, func(na fluent.MapNodeAssembler) {
					na.AssembleDirectly(selector.SelectorKey_ExploreAll).CreateMap(1, func(na fluent.MapNodeAssembler) {
						na.AssembleDirectly(selector.SelectorKey_Next).CreateMap(1, func(na fluent.MapNodeAssembler) {
							na.AssembleDirectly(selector.SelectorKey_ExploreRecursiveEdge).CreateMap(0, func(na fluent.MapNodeAssembler) {})
						})
	...
	t.Run("ExploreUnion builds ExploreUnion nodes", func(t *testing.T) {
		...
		esn := fluent.MustBuildMap(ns, 1, func(na fluent.MapNodeAssembler) {
			na.AssembleDirectly(selector.SelectorKey_ExploreUnion).CreateList(2, func(na fluent.ListNodeAssembler) {
		...
		esn := fluent.MustBuildMap(ns, 1, func(na fluent.MapNodeAssembler) {
			na.AssembleDirectly(selector.SelectorKey_ExploreFields).CreateMap(1, func(na fluent.MapNodeAssembler) {
				na.AssembleDirectly(selector.SelectorKey_Fields).CreateMap(1, func(na fluent.MapNodeAssembler) {
					na.AssembleDirectly("applesauce").CreateMap(1, func(na fluent.MapNodeAssembler) {
						na.AssembleDirectly(selector.SelectorKey_Matcher).CreateMap(0, func(na fluent.MapNodeAssembler) {})
					})
				})
			})
